...
const Registration = () => {
  ...
  return (
    <ContentLayout>
      <Header
        title={SERVICES[serviceId].entity}
      ...
      <Container>
        <Switch>
          ...
          />
          <Route
            path={`${SERVICES[serviceId].url}/form`}
            exact
            render={() => (
              <React.Fragment>
                <BackButton url="/city" />
          ...
          />
          <Route
            path={`${SERVICES[serviceId].url}/submitted`}
            exact
            render={() => <Receive />}
          />
          <Route
            path={`${SERVICES[serviceId].url}/complete`}
            exact
            render={() => (
              <React.Fragment>
          ...
          />
          <Route
            path={`${SERVICES[serviceId].url}/exists`}
            exact
            render={() => (
              <React.Fragment>
                <BackButton url="/" label={t("Back to Home")} />
